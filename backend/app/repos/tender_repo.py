...
_tender_repo_instance = None


def get_tender_repo() -> "TenderRepo":
    """FastAPI dependency that returns a singleton TenderRepo instance."""
    global _tender_repo_instance
    if _tender_repo_instance is None:
        client = get_mongo_client()
        _tender_repo_instance = TenderRepo(client)
    return _tender_repo_instance
